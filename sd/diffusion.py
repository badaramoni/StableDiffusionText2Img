...
class UNET_ResidualBlock(nn.Module):
    ...
    def __init__(self,in_channels: int, out_channels:int, n_time= 1280):
        ...
        self.conv_feature = nn.Conv2d(in_channels,out_channels,kernel_size=3, padding=3)
    ...
    def forward(self,feature,time):
        ...
        merged = feature + time.unsqueeze(-1).unsquezze(-1)
...
class UNET(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoders = nn.Module([
            ...
            SwitchSequential(UNET_ResidualBlock(320,1280), UNET_AttentionBlock(8,160)),
